        ...
        <>
          {
            ...
            <h1 className="text-center text-black display-4" style={{fontFamily:"Times New Roman"}}><b>By Filtering Skills</b></h1>
            <div className="row justify-content-center">
                <div className="col-lg-6 col-md-10 col-sm-12 shadow p-5 rounded-5" style={{backgroundColor:"rgb(227,227,227)"}}>
                    ...
                    <button className="btn btn-success col-2" onClick={onTech}>
